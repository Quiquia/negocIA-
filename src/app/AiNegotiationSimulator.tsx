...
import { User, ShieldCheck, Send, StopCircle, Bot, Sparkles, ChevronLeft, MessageSquare, Plus, History, Lightbulb, CheckCircle2, TrendingUp } from "lucide-react";
...
export function AiNegotiationSimulator() {
    ...
    <div className="flex h-[calc(100vh-4rem)] w-full bg-background">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-background relative">
        ...
        <div className="bg-white/80 backdrop-blur-xl border-b border-border px-6 py-4 flex items-center justify-between shrink-0 shadow-sm z-10 sticky top-0">
          ...
          <button
            onClick={() => navigate("/confidence-score")}
            ...
            <AnimatePresence initial={false}>
              {messages.map((msg) => (
                <motion.div
                  ...
                  } ${msg.role === "coach" ? "w-full justify-center" : ""}`}
                >
                  {msg.role !== "coach" && (
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex flex-shrink-0 items-center justify-center shadow-md ${
                  ...
                  {msg.role === "coach" ? (
                    ...
                    <div className={`max-w-[85%] md:max-w-[75%] rounded-3xl px-6 py-4 md:py-5 shadow-sm text-[16px] leading-relaxed font-medium ${
                      msg.role === "user" 
            ...
            <div className="pt-4 pb-2 px-4 md:px-6">
              ...
              <AnimatePresence>
                {showSuggestions && (
                  ...
                  >
                    <div className="flex overflow-x-auto pb-3 pt-1 gap-3 scrollbar-hide snap-x" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
