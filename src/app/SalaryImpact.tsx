...
import { TrendingUp, AlertCircle, Sparkles, Briefcase, ChevronRight, BarChart3, Clock, DollarSign } from "lucide-react";
...
export function SalaryImpact() {
  ...
  const currentSalary = state?.currentSalary ? Number(state.currentSalary) : 5500;
  const averageSalary = state?.averageSalary ? Number(state.averageSalary) : 7800;
  ...
  const data = [
    {
      id: "current",
      name: "Si tu salario actual se mantiene",
      value: current10Years,
      fill: "#9333EA" // Vibrant Purple
    },
    {
      id: "average",
      name: "Salario promedio del mercado",
      value: average10Years,
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
          <div className="flex-1 w-full h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data} margin={{ top: 20, right: 0, left: 0, bottom: 0 }} barSize={70} accessibilityLayer={false}>
          ...
          <div className="lg:w-[400px] w-full bg-gradient-to-br from-rose-50 to-rose-100 border border-rose-100 p-8 md:p-10 rounded-[2rem] text-center shadow-inner">
            ...
            <p className="text-5xl font-black font-heading text-rose-900">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <p className="text-2xl md:text-3xl font-bold font-heading">
            Tú tienes el poder de cambiar esto.
          </p>
        </div>
