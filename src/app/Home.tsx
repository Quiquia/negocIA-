...
import { ArrowRight, Sparkles, TrendingUp, BarChart3, AlertCircle, ShieldAlert, Target, Users, Play, Calculator, Presentation, MessageSquare, Bot, Search, MapPin, Briefcase, CheckCircle2 } from "lucide-react";
  ...
  const PROFILES = [
    {
      ...
      image: "https://images.unsplash.com/photo-1573495612937-f01934eeaaa7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080",
      insight: "Tu stack de React y Node.js aumenta tu valor en un +18% en tu región.",
      salary: "$145,000",
      increase: "+25% vs Actual"
    },
    {
      role: "Data Analyst",
      image: "https://images.unsplash.com/photo-1752982527498-214487bd9540?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080",
      insight: "Tu experiencia con Python y SQL tiene alta demanda este trimestre.",
      salary: "$118,000",
      increase: "+18% vs Actual"
    },
    {
      role: "Frontend Developer",
      image: "https://images.unsplash.com/photo-1573164574001-518958d9baa2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080",
      insight: "Tu especialización en UI/UX y accesibilidad te posiciona en el top 10%.",
      salary: "$132,000",
    ...
    <div className="flex flex-col w-full bg-background overflow-hidden">
      ...
      <section className="relative w-full pt-20 pb-28 px-6 md:px-12 lg:px-24 overflow-hidden bg-gradient-to-br from-secondary via-accent/80 to-secondary text-white min-h-[90vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10 w-full">
          <div className="flex flex-col gap-8 max-w-2xl">
            ...
            {/* Embedded Salary Simulation Form */}
            <HeroSalaryForm />
          ...
          >
            {/* Base glowing orb behind everything */}
            <motion.div 
              ...
              <div className="absolute bottom-4 left-0 right-0 z-20 flex justify-center gap-2">
                {PROFILES.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${i === activeProfile ? "w-6 bg-primary" : "bg-white/40 hover:bg-white/60"}`}
                  />
                ))}
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <p className="text-xs font-semibold text-white/60 mb-1 uppercase tracking-wider relative z-10">Salario Objetivo</p>
            ...
            {/* Floating Element 4: Mini Sparkle/Data nodes */}
            <motion.div 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-xl">
              Nuestra IA te acompaña en cada paso para cerrar la brecha salarial.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-sm ${feature.iconColor} group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(255,46,147,0.3)] transition-all`}>
                ...
                <Link to={feature.link} className="inline-flex items-center gap-2 font-bold text-lg text-primary hover:opacity-70 transition-opacity">
      ...
      <section className="w-full py-24 px-6 md:px-12 lg:px-24 bg-secondary text-white text-center relative overflow-hidden">
         ...
         <div className="max-w-4xl mx-auto flex flex-col items-center relative z-10">
            <h2 className="text-4xl md:text-6xl font-black font-heading mb-8">Toma el control de tu futuro hoy</h2>
            <Link 
              to="/salary-input"
